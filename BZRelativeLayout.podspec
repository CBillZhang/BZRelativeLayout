...
Pod::Spec.new do |s|
  ...
  s.author             = { "Bill.Zhang" => "c_billzhang@outlook.com" }
  # Or just: s.author    = "Bill.Zhang"
  # s.authors            = { "Bill.Zhang" => "602101388@qq.com" }
  # s.social_media_url   = "http://twitter.com/Bill.Zhang"
